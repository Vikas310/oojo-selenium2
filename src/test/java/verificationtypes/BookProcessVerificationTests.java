...
public class BookProcessVerificationTests extends BaseTest {
    ...
    public void cntPhoneVerificationSuccessScreen() {
        ...
        Assert.assertTrue(bookSuccessPageObject.getPhoneVerificationMessage().isDisplayed());
    ...
    public void cntChargeVerificationSuccessScreen() {
        ...
        Assert.assertTrue(bookSuccessPageObject.getChargeCntSuccessMessage().isDisplayed());
    }
    ...
    public void cntTakePhotoVerificationSuccessScreen() {
        ...
        Assert.assertTrue(bookSuccessPageObject.getCntTakePhotoSuccessMessage().isDisplayed());
    }
