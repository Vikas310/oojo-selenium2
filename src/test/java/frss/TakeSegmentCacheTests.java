...
public class TakeSegmentCacheTests extends BaseTest {
    ...
    @Test
    public void searchFlightAndOpenSavedUrlFromNewYorkToLosAngelosAndOpenCachedUrl() {
    ...
    @Test
    public void searchFlightAndOpenSavedUrlFromNewYorkToMiamiAndOpenCachedUrl() {
    ...
    @Test
    public void searchDallasToLahoreAndBookOneMonthAwayAndOpenCachedUrl() {
    ...
    @Test
    public void searchNewYorkToMiamiAndBookFourMonthsAwayAndOpenCachedUrl() {
    ...
    @Test
    public void searchFromMcCarranToCansasAndBookTenDaysAwayAndOpenCachedUrl() {
        int flight = 0;

        String customDate = Helper.getDateWithSpecificDaysInFuture(Constants.TEN_DAYS,"yyyy-MM-dd");
        String fullUrl = BaseClass.OOJO_URL+Helper.getFlightSearchResultOneWay(
                FlightCodes.MCCARRAN_INIT_CODE,
