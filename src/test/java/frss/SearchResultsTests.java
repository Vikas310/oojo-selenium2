...
public class SearchResultsTests extends BaseTest {
    ...
    public void checkSeveralTakeSegmentsAndIfFailsCheckIfTheFlightWasDeleted() {
        ...
        for (int i = 0; i <= allFlightsDatesFromSearchListCount; i++) {
            ...
            //assert flight date
            String bookScreenStartFlightDate = bookPageObject.getBookScreenFlightStartDate(0).getText();
            String bookScreenStartFlightTime = bookPageObject.getBookScreenFlightStartTime(0).getText();
